...
var WorldManager = function (appconfig, jsonApi, actionManager) {
    var that = this;
    ...
    that.getColumnKeys = function (typeName, callback) {
        ...
        axios_1.default(appconfig.apiRoot + '/jsmodel/' + typeName + ".js", {
            headers: {
                "Authorization": "Bearer " + getToken()
            },
        }).then(function (r) {
    ...
    that.columnTypes = [];
    axios_1.default(appconfig.apiRoot + "/meta?query=column_types", {
        headers: {
            "Authorization": "Bearer " + getToken()
        }
    }).then(function (r) {
